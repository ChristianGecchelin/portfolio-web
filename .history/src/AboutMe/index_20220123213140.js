    ...
    <section className="AboutMe-container" id="about">
      ...
      <div className="information-container">
        <p className="">
          ...
          about a lot of different things. You can see all my projects in the
          next slide, there you can see that I have project based on frontEnd
          technologies like HTML5, CSS3, vanilla JavaScript as well as ReactJs.
          Furthermore I'm looking for my first professional experience as an
          employee.
        </p>
