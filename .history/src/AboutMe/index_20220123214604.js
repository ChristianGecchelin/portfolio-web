    ...
    <section className="AboutMe-container" id="about">
      ...
      <div className="information-container">
        <p className="">
          ...
          born in Argentina but I'm living in Barcelona at the moment. I
          consider myself as an enthusiast of technologies, who likes the
          challenges and learn about a lot of different things.
        </p>
        <p>
